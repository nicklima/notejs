  ...
  <div className="about">
    ...
    <div className="container">
      ...
      <p>
        ...
        Trabalho no setor desde 2005 e já desenvolvi grandes projetos, como o
        site dos cantores "Wesley Safadão" e "Aldair Playboy", o Portal
        "Investimentos para Você" e vários outros.
      </p>
      <SocialNetwork data={Social.nick} />
      <h2>Objetivos</h2>
      <p>
        Apesar de já atuar na área, decidi fazer o curso do Nardini com o
        objetivo de fazer um reciclagem e também ganhar um melhor embasamento
        teórico e dessa forma melhorar ainda mais como desenvolvedor.
      </p>
    </div>
  </div>
);
